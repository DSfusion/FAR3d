...
!  u-zeta equation
		...
		write(*,'(/"bet0 = ",e12.4,3x,"betf0_f = ",e12.4)') bet0, bet0_f
		write(*,'("eps = <a>/<R> = ",e12.4,3x,"S = tau_R/tau_A = ",e12.4)') eps, s
		write(*,'("bet0/eps**2 = ",e12.4,3x,"bet0_f/eps**2 = ",e12.4)') betfc, betfc_f
